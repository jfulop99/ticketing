...
class PartnerControllerIT {
    ...
    void findAllPartnersTest() {
        ...
        template.postForObject("/api/ticketing/partner",
    ...
    void findPartnerByIdTest() {
        PartnerDto partner = template
                .postForObject("/api/ticketing/partner",
                        new createPartnerCommand("Hotel Intercontinental", "0025",
                                new Address("H-1051", "Budapest", "Szécheny tér 1.", null)),
                        PartnerDto.class);
        ...
        partner = template
                .getForObject(String.format("/api/ticketing/partner/%d", id), PartnerDto.class);
    ...
    void updatePartnerByIdTest() {
        ...
        template.put(String.format("/api/ticketing/partner/%d", id),
    ...
    void deletePartnerByIdTest() {
        ...
        template.delete(String.format("/api/ticketing/partner/%d", id));

        Problem problem = template.getForObject(String.format("/api/ticketing/partner/%d", id), Problem.class);
